<header class="demo-header mdl-layout__header gold">
    <div class="mdl-layout__header-row">
        <span class="mdl-layout-title ciel">Titre</span>
        <div class="mdl-layout-spacer"></div>

        <div id="morphsearch" class="morphsearch">
        <form class="morphsearch-form">
            <input class=" morphsearch-input " type="search" placeholder="Search..." style="border:black;"/>
        ...
        <div class="morphsearch-content">
            ...
            <div class="dummy-column">
                ...
                <a class="dummy-media-object" href="http://tympanus.net/codrops/2014/05/28/arrow-navigation-styles/">
                    <img src="images/my-rocket.png" alt="ArrowNavigationStyles"/>
                    <h3>My-Rocket</h3>
                </a>
            ...
            <div class="dummy-column">
                ...
                <a class="dummy-media-object" href="http://tympanus.net/codrops/2014/10/07/tooltip-styles-inspiration/">
                    <img src="images/e1.png" alt="TooltipStylesInspiration"/>
                    <h3>Rechargez votre compte Izly en ligne </h3>
                </a>
                <a class="dummy-media-object" href="http://tympanus.net/codrops/2014/09/23/animated-background-headers/">
                    <img src="images/e2.png" alt="AnimatedHeaderBackgrounds"/>
                ...
                <a class="dummy-media-object" href="http://tympanus.net/codrops/2014/09/16/off-canvas-menu-effects/">
                    <img src="images/e3.png" alt="OffCanvas"/>
